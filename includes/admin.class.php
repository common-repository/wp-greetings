...
if (!class_exists('WPGreetBoxAdmin')) {
  ...
  class WPGreetBoxAdmin {
    ...
    function WPGreetBoxAdmin($plugin) {
      ...
      // activation hook
      register_activation_hook(dirname(dirname(__FILE__)).'/dynamic-wp-greetbox.php', array($this, 'activate'));
 	...
 	'deprecated'            => array(),
        ...
        'messages'              => array(
          ...
          array(
            ...
            'show_till_close' => 0,
            'timeout'         => 0,
            'text'            => 'Hello there fellow <strong>Reddit</strong> user! If you like this article, please remember to <a href="http://www.reddit.com/submit?url=[[escaped-permalink]]&title=[[title]]" rel="nofollow"><strong>vote for this article</strong></a> on Reddit.'
          ),
          array(
            'referrer'        => 'simpy.com',
            'disable'         => 0,
          ...
          array(
            ...
            'show_till_close' => 1,
            'timeout'         => 1440,
            'text'            => 'Hello there <strong>Bing</strong> decision maker! If you find this page interesting, you might want to <a href="[[rss-link]]" rel="nofollow"><strong>subscribe to the RSS feed</strong></a> for updates on this topic.'
          ),
          array(
            'referrer'        => 'wikio.com',
            'disable'         => 0,
            ...
            'show_till_close' => 0,
            'timeout'         => 0,
            'text'            => 'Hello there <strong>Wikio</strong> user! If you find this article useful, then you should consider <a href="[[rss-link]]" rel="nofollow"><strong>subscribing to the RSS feed</strong></a> in your feed reader.'
          ),
          array(
            ...
            'show_till_close' => 0,
            'timeout'         => 0,
            'text'            => 'Hello there <strong>Scoopeo</strong> user! If you find this article useful, then you should consider <a href="[[rss-link]]" rel="nofollow"><strong>subscribing to the RSS feed</strong></a> in your feed reader.'
          ),
          array(
            ...
            'show_till_close' => 0,
            'timeout'         => 0,
            'text'            => 'Hello there <strong>Designrfix</strong> reader! If you find this article useful, then you should consider <a href="[[rss-link]]" rel="nofollow"><strong>subscribing to the RSS feed</strong></a> in your feed reader.'
          ),
          array(
            ...
            'show_till_close' => 0,
            'timeout'         => 0,
            'text'            => 'Hello there <strong>Web Design News</strong> reader! If you find this article useful, then you should consider <a href="[[rss-link]]" rel="nofollow"><strong>subscribing to the RSS feed</strong></a> in your feed reader.'
          ),
          array(
            'referrer'        => 'dzone.com',
            'disable'         => 0,
            ...
            'show_till_close' => 0,
            'timeout'         => 0,
            'text'            => 'Hello there <strong>DZone</strong> user! If you think this is a fresh link, then you should consider <a href="http://www.dzone.com/links/add.html?noDupe=true&description=&url=[[escaped-permalink]]&title=[[title]]" rel="nofollow"><strong>voting up this post</strong></a> on DZone.'
          )
        )
      );
    }
    ...
    function activate_ext() {
      $plugin_path = 'dynamic-wp-greetbox-ext/dynamic-wp-greetbox-ext.php';
