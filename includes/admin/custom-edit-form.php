...
<form id="wpgb_custom_message_form_<?php echo $id ?>" action="index.php" method="post">
  ...
  <input name="wpgb_message[referrer]" type="text" class="wpgb_focusable" value="<?php echo attribute_escape($m['referrer']) ?>"/><br/><br/> 
  ...
  <input name="wpgb_message[timeout]" type="text" class="wpgb_focusable" value="<?php echo attribute_escape($m['timeout']) ?>"/><br/><br/>
  <?php _e('Greeting Icon (optional)', $this->p->name) ?>:<br/>
  <input name="wpgb_message[icon]" type="text" class="wpgb_focusable widefat" value="<?php echo attribute_escape($m['icon']) ?>"/><br/><br/>
  <?php _e('Greeting Icon Link (optional)', $this->p->name) ?>:<br/>
  <input name="wpgb_message[icon_link]" type="text" class="wpgb_focusable widefat" value="<?php echo attribute_escape($m['icon_link']) ?>"/><br/><br/>
  <?php _e('Greeting message', $this->p->name) ?>:<br/>
  <textarea name="wpgb_message[text]" class="wpgb_focusable widefat" rows="4"><?php echo attribute_escape($m['text']) ?></textarea><br/><br/>
