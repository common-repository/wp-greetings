...
function confirm_import() {
  var answer = confirm("<?php _e('All of your current Wp Greetings options will be overwritten by the imported value.  Are you sure you want to overwrite all settings?', $this->p->name); ?>");
  if(answer)
    return true;
  else
    return false;
...
<form method="post">
  <p><?php _e('This functionality will dump your entire Wp Greetings options into a file.', $this->p->name) ?></p>
  <p class="submit">
...
<form method="post" enctype="multipart/form-data">
  ...
  <p>
    <?php _e('This functionality will restore your entire Wp Greetings options from a file.', $this->p->name) ?><br/>
