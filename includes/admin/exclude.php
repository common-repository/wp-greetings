<form method="post">
  ...
  <p><label for="exclude-referrer">
    ...
    <textarea name="wpgb_options_exclusion[exclude_referrer]" id="exclude-referrer" class="wpgreetbox-focusable widefat" rows="8"><?php echo attribute_escape($this->p->o['exclude_referrer']) ?></textarea>
  </label></p>
